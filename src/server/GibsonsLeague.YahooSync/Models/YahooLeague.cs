...
namespace GibsonsLeague.YahooSync.Models
{
    ...
    public class YahooLeague
    {
        ...
        public YahooScoreboard Scoreboard { get; set; }

        [XmlElement(ElementName = "draft_results", Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public DraftResults DraftResults { get; set; }

        [XmlElement(ElementName = "transactions", Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
        public YahooTransactions Transactions { get; set; }

    }

    [XmlRoot(ElementName = "leagues", Namespace = "http://fantasysports.yahooapis.com/fantasy/v2/base.rng")]
    public class YahooLeagueList
    {
